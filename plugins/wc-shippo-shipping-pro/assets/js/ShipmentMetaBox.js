(function (settings) {
	...
	ShipmentMetaBox.prototype.switchFormToFetchRates = function () {
		...
		jQuery('#' + this.settings.metaBoxContentsId + ' button.fetchShippingRates').css({display: 'inline-block'});
		jQuery('#' + this.settings.metaBoxContentsId + ' button.createShipment').css({display: 'none'});
		jQuery('#' + this.settings.metaBoxContentsId + ' button.buyShipment').css({display: 'none'});
	};

	ShipmentMetaBox.prototype.switchFormToCreate = function () {
		jQuery('#' + this.settings.metaBoxContentsId + ' button.fetchShippingRates').css({display: 'none'});
		jQuery('#' + this.settings.metaBoxContentsId + ' button.createShipment').css({display: 'inline-block'});
		jQuery('#' + this.settings.metaBoxContentsId + ' button.buyShipment').css({display: 'inline-block'});
	};
	...
	ShipmentMetaBox.prototype.hideAllForms = function () {
		...
		if (this.canCreateShipment()) {
			jQuery('#' + this.settings.metaBoxContentsId + ' .showAddShipment').css({display: 'inline-block'});
			jQuery('#' + this.settings.metaBoxContentsId + ' .showLinkShipment').css({display: 'inline-block'});
		}

		jQuery('#' + this.settings.metaBoxContentsId + ' .shipmentDetails').css({display: 'block'});
		jQuery('#' + this.settings.metaBoxContentsId + ' .linkShipmentForm').css({display: 'none'});
		jQuery('#' + this.settings.metaBoxContentsId + ' .addShipmentForm').css({display: 'none'});

		jQuery('table .' + this.settings.id + '.itemsInParcel').css({display: 'none'});
	};
	...
	ShipmentMetaBox.prototype.showItemsInParcel = function () {
		jQuery('table .' + this.settings.id + '.itemsInParcel').css({display: 'table-cell'});
	};
	...
	ShipmentMetaBox.prototype.showAddShipmentForm = function () {
		...
		jQuery('#' + this.settings.metaBoxContentsId + ' .addShipmentForm').css({display: 'block'});

		jQuery('#' + this.settings.metaBoxContentsId + ' .showAddShipment').css({display: 'none'});
		jQuery('#' + this.settings.metaBoxContentsId + ' .showLinkShipment').css({display: 'none'});
		jQuery('#' + this.settings.metaBoxContentsId + ' .shipmentDetails').css({display: 'none'});
	...
	ShipmentMetaBox.prototype.showLinkShipmentForm = function () {
		...
		jQuery('#' + this.settings.metaBoxContentsId + ' .linkShipmentForm').css({display: 'block'});
	};
	...
	ShipmentMetaBox.prototype.getSerializedFormData = function () {
		let elements = jQuery('#' + this.settings.metaBoxContentsId + ' :input, .' + this.settings.id + '.itemsInParcel :input').not('button');

		// some plugins can change value of unchecked checkboxes to NO
		elements.filter('[type="checkbox"][value="no"]:checked').val('1');
