	...
	foreach ($shipments as $shipment) {
		...
		<tr>
			...
			<td data-title="<?php _e('Date', $id); ?>" style="text-align:left; white-space:nowrap;">
				<time datetime="<?php echo date_i18n('Y-m-d', $shipment['ship_date']); ?>" title="<?php echo date_i18n('Y-m-d', $shipment['ship_date']); ?>"><?php echo date_i18n(get_option('date_format'), $shipment['ship_date']); ?></time>
			</td>
			...
			foreach ($shipment['tracking_events'] as $event) {
				...
				?>
						<tr>
							...
							<td data-title="<?php _e('Date', $id); ?>" style="text-align:left; white-space:nowrap;">
								<time datetime="<?php echo date_i18n('Y-m-d', $event['created_at']); ?>" title="<?php echo date_i18n('Y-m-d', $event['created_at']); ?>"><?php echo date_i18n(get_option('date_format'), $event['created_at']); ?></time>
							</td>
						</tr>
				<?php
			}
